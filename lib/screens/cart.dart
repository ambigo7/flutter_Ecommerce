                            ...
                            children: <Widget>[
                              RichText(
                                text: TextSpan(children: [
                                  TextSpan(
                                      text: '${userProvider.userModel.cart[index].nameProduct.length > 10
                                          ? userProvider.userModel.cart[index].nameProduct
                                          .replaceRange(11, userProvider.userModel.cart[index].nameProduct.length, '...')
                ...
                child: FlatButton(
                    onPressed: () {
                      ...
                      changeScreen(context, CheckOut(
                        totalLensPrice: userProvider.userModel.totalLensPrice,
                        totalProductPrice: userProvider.userModel.totalProductPrice,
