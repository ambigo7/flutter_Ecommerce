...
// buat convert ke map
  ...
  List<Map> _convertMapAdjustLens(List<AdjustLens> _adjustLens){
    List<Map> convertedAdjustLens = [];
    for(AdjustLens adjustLensItem in _adjustLens){
      convertedAdjustLens.add(adjustLensItem.toMap());
    }
    return convertedAdjustLens;
  }

  List<AdjustLens> _convertAdjustLens(List _adjustLens){
    List<AdjustLens> convertedAdjustLens = [];
    for(Map adjustLensItem in _adjustLens){
      convertedAdjustLens.add(AdjustLens.fromMap(adjustLensItem));
    }
    return convertedAdjustLens;
  }
}
